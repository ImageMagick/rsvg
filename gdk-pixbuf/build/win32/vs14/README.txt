...
b) Build them yourself with VS14 (but you may most probably wish to get
   ...
   is built using the win32/Makefile.msc makefile with VS14 with the ASM routines
...
<root>\gdk-pixbuf\<this-gdk-pixbuf-source-tree>\build\win32\vs14\README.

<PlatformName> is either Win32 or x64, as in the VS14 project files.
...
<root>\vs14\<PlatformName>\lib (LIBs, also glib-2.0/include/glibconfig.h)
...
<root>\vs14\<PlatformName>\lib and GDK-Pixbuf headers into
<root>\vs14\<PlatformName>\include\GDKPixbuf-2.0. This is then from where
