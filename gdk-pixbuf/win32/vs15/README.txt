...
b) Build them yourself with VS15 (but you may most probably wish to get
   ...
   is built using the win32/Makefile.msc makefile with VS15 with the ASM routines
...
<root>\gdk-pixbuf\<this-gdk-pixbuf-source-tree>\win32\vs15\README.

<PlatformName> is either Win32 or x64, as in the VS15 project files.
...
<root>\vs15\<PlatformName>\lib (LIBs, also glib-2.0/include/glibconfig.h)
...
<root>\vs15\<PlatformName>\lib and GDK-Pixbuf headers into
<root>\vs15\<PlatformName>\include\GDKPixbuf-2.0. This is then from where
